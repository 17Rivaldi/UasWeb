...
<body>
    ...
    <div class="container text-center" id="produk">
        <h2>Monitor Gaming</h2>
        <div class="row align-items-center">
            <div class="col">
                <div class="card" style="width: 18rem;">
                    <img src="../img/gaming/Gigabyte G24F.jpg" class="card-img-top" alt="Produk 1">
                    <div class="card-body">
                        <h5 class="card-title">Gigabyte G24F 23.8" FHD</h5>
                    </div>
                    <ul class="list-group list-group-flush">
                        <li class="list-group-item">Layar Full HD (1920 x 1080) 23.8"</li>
                        <li class="list-group-item">Kecepatan Refresh 165Hz</li>
                        <li class="list-group-item">Respon time 1ms</li>
                        <li class="list-group-item">Rp 2.485.000</li>
                    </ul>
            ...
            <div class="col">
                <div class="card" style="width: 18rem;">
                    <img src="../img/gaming/ACER Nitro VG240Y.jpg" class="card-img-top" alt="Produk 1">
                    <div class="card-body">
                        <h5 class="card-title">ACER Nitro VG240Y 23.8"</h5>
                    </div>
                    <ul class="list-group list-group-flush">
                        <li class="list-group-item">Layar Full HD (1920 x 1080) 23.8"</li>
                        <li class="list-group-item">Kecepatan Refresh 75Hz</li>
                        <li class="list-group-item">Respon time 1ms</li>
                        <li class="list-group-item">Rp 1.989.000</li>
                    </ul>
                    <div class="card-body d-flex justify-content-center">
                        <button type="button" class="btn btn-primary">Tambah Ke Keranjang</button>
                    </div>
            ...
            <div class="col">
                <div class="card" style="width: 18rem;">
                    <img src="../img/gaming/MSI Optix G241VC.jpg" class="card-img-top" alt="Produk 1">
                    <div class="card-body">
                        <h5 class="card-title">MSI Optix G241VC 24" Curved</h5>
                    </div>
                    <ul class="list-group list-group-flush">
                        <li class="list-group-item">Layar Full HD (1920 x 1080) 24"</li>
                        <li class="list-group-item">Kecepatan Refresh 75Hz</li>
                        <li class="list-group-item">Respon time 1ms</li>
                        <li class="list-group-item">Rp 2.399.000</li>
                    </ul>
                    <div class="card-body d-flex justify-content-center">
                        <button type="button" class="btn btn-primary">Tambah Ke Keranjang</button>
                    </div>
            ...
            <div class="col">
                <div class="card" style="width: 18rem;">
                    <img src="../img/gaming/Koorui24e4.jpg" class="card-img-top" alt="Produk 1">
                    <div class="card-body">
                        <h5 class="card-title">KOORUI 24E3 24" FHD</h5>
                    </div>
                    <ul class="list-group list-group-flush">
                        <li class="list-group-item">Layar Full HD (1920 x 1080) 24"</li>
                        <li class="list-group-item">Kecepatan Refresh 165Hz</li>
                        <li class="list-group-item">Respon Time 1ms</li>
                        <li class="list-group-item">Rp 1.680.000</li>
                    </ul>
                    <div class="card-body d-flex justify-content-center">
                        <button type="button" class="btn btn-primary">Tambah Ke Keranjang</button>
                    </div>
            ...
            <div class="col">
                <div class="card" style="width: 18rem;">
                    <img src="../img/gaming/Viewsonic VX2780-2K.jpg" class="card-img-top" alt="Produk 1">
                    <div class="card-body">
                        <h5 class="card-title">Viewsonic VX2780-2K 27"</h5>
                    </div>
                    <ul class="list-group list-group-flush">
                        <li class="list-group-item">Layar Full HD (1920 x 1080) 27"</li>
                        <li class="list-group-item">Kecepatan Refresh 170Hz</li>
                        <li class="list-group-item">Respon time 1ms</li>
                        <li class="list-group-item">Rp 1.549.000</li>
                    </ul>
                    <div class="card-body d-flex justify-content-center">
                        <button type="button" class="btn btn-primary">Tambah Ke Keranjang</button>
                    </div>
            ...
            <div class="col">
                <div class="card" style="width: 18rem;">
                    <img src="../img/gaming/BenQ MOBIUZ EX2710S.jpg" class="card-img-top" alt="Produk 1">
                    <div class="card-body">
                        <h5 class="card-title">BenQ MOBIUZ EX2710S 27"</h5>
                    </div>
                    <ul class="list-group list-group-flush">
                        <li class="list-group-item">Layar Full HD (1920 x 1080) 27"</li>
                        <li class="list-group-item">Kecepatan Refresh 165Hz</li>
                        <li class="list-group-item">Respon time 1ms</li>
                        <li class="list-group-item">Rp 3.990.000</li>
                    </ul>
                    <div class="card-body d-flex justify-content-center">
                        <button type="button" class="btn btn-primary">Tambah Ke Keranjang</button>
                    </div>
            ...
            <div class="col">
                <div class="card" style="width: 18rem;">
                    <img src="../img/gaming/SAMSUNG S27AG32.jpg" class="card-img-top" alt="Produk 1">
                    <div class="card-body">
                        <h5 class="card-title">SAMSUNG S27AG32 Odyssey G3 FHD 27"</h5>
                    </div>
                    <ul class="list-group list-group-flush">
                        <li class="list-group-item">Layar Full HD (1920 x 1080) 27"</li>
                        <li class="list-group-item">Kecepatan Refresh 165Hz</li>
                        <li class="list-group-item">Respon time 1ms</li>
                        <li class="list-group-item">Rp 3.142.000</li>
                    </ul>
                    <div class="card-body d-flex justify-content-center">
                        <button type="button" class="btn btn-primary">Tambah Ke Keranjang</button>
                    </div>
            ...
            <div class="col">
                <div class="card" style="width: 18rem;">
                    <img src="../img/gaming/AOC 24G2SPU.jpg" class="card-img-top" alt="Produk 1">
                    <div class="card-body">
                        <h5 class="card-title">AOC 24G2SPU FHD 23.8"</h5>
                    </div>
                    <ul class="list-group list-group-flush">
                        <li class="list-group-item">Layar Full HD (1920 x 1080) 23.8"</li>
                        <li class="list-group-item">Kecepatan Refresh 165Hz</li>
                        <li class="list-group-item">Respon time 1ms</li>
                        <li class="list-group-item">Rp 2.679.000</li>
                    </ul>
                    <div class="card-body d-flex justify-content-center">
                        <button type="button" class="btn btn-primary">Tambah Ke Keranjang</button>
                    </div>
