        ...
        <div class="row align-items-center">
            <div class="col">
                <div class="card" style="width: 18rem;">
                    <img src="../img/standart/Philips 221V8A.jpg" class="card-img-top" alt="Produk 1">
                    <div class="card-body">
                        <h5 class="card-title">Philips 221V8A 22"</h5>
                    </div>
                    <ul class="list-group list-group-flush">
                        <li class="list-group-item">Layar Full HD (1920 x 1080) 22"</li>
                        <li class="list-group-item">Kecepatan Refresh 75Hz</li>
                        <li class="list-group-item">Respon time 4ms</li>
                        <li class="list-group-item">Rp 989.899</li>
                    </ul>
            ...
            <div class="col">
                <div class="card" style="width: 18rem;">
                    <img src="../img/standart/ViewSonic VA1903.jpg" class="card-img-top" alt="Produk 1">
                    <div class="card-body">
                        <h5 class="card-title">ViewSonic VA1903 19"</h5>
                    </div>
                    <ul class="list-group list-group-flush">
                        <li class="list-group-item">Layar (1366x768) 19"</li>
                        <li class="list-group-item">Kecepatan Refresh 60Hz</li>
                        <li class="list-group-item">Respon time 5ms</li>
                        <li class="list-group-item">Rp 919.900</li>
                    </ul>
                    <div class="card-body d-flex justify-content-center">
                        <button type="button" class="btn btn-primary">Tambah Ke Keranjang</button>
                    </div>
            ...
            <div class="col">
                <div class="card" style="width: 18rem;">
                    <img src="../img/standart/Philips 221V8.jpg" class="card-img-top" alt="Produk 1">
                    <div class="card-body">
                        <h5 class="card-title">Philips 221V8 22"</h5>
                    </div>
                    <ul class="list-group list-group-flush">
                        <li class="list-group-item">Layar (1920x1080) 22"</li>
                        <li class="list-group-item">Kecepatan Refresh 75Hz</li>
                        <li class="list-group-item">Respon time 4ms</li>
                        <li class="list-group-item">Rp 1.069.900</li>
                    </ul>
                    <div class="card-body d-flex justify-content-center">
                        <button type="button" class="btn btn-primary">Tambah Ke Keranjang</button>
                    </div>
            ...
            <div class="col">
                <div class="card" style="width: 18rem;">
                    <img src="../img/standart/LG 20MK400A.jpg" class="card-img-top" alt="Produk 1">
                    <div class="card-body">
                        <h5 class="card-title">LG 20MK400A 19.5"</h5>
                    </div>
                    <ul class="list-group list-group-flush">
                        <li class="list-group-item">Layar (1366 x 768) 19.5"</li>
                        <li class="list-group-item">Kecepatan Refresh 60Hz</li>
                        <li class="list-group-item">Respon Time 5ms</li>
                        <li class="list-group-item">Rp 1.098.900</li>
                    </ul>
                    <div class="card-body d-flex justify-content-center">
                        <button type="button" class="btn btn-primary">Tambah Ke Keranjang</button>
                    </div>
            ...
            <div class="col">
                <div class="card" style="width: 18rem;">
                    <img src="../img/standart/HP G5 P22v.jpg" class="card-img-top" alt="Produk 1">
                    <div class="card-body">
                        <h5 class="card-title">HP G5 P22v 22"</h5>
                    </div>
                    <ul class="list-group list-group-flush">
                        <li class="list-group-item">Layar (1920 x 1080) 22"</li>
                        <li class="list-group-item">Kecepatan Refresh 75Hz</li>
                        <li class="list-group-item">Respon time 5ms</li>
                        <li class="list-group-item">Rp 1.189.900</li>
                    </ul>
                    <div class="card-body d-flex justify-content-center">
                        <button type="button" class="btn btn-primary">Tambah Ke Keranjang</button>
                    </div>
            ...
            <div class="col">
                <div class="card" style="width: 18rem;">
                    <img src="../img/standart/Lenovo L22e-40.jpg" class="card-img-top" alt="Produk 1">
                    <div class="card-body">
                        <h5 class="card-title">Lenovo L22e-40 22"</h5>
                    </div>
                    <ul class="list-group list-group-flush">
                        <li class="list-group-item">Layar (1920 x 1080) 22"</li>
                        <li class="list-group-item">Kecepatan Refresh 75Hz</li>
            ...
            <div class="col">
                <div class="card" style="width: 18rem;">
                    <img src="../img/standart/AOC 24B3HM.jpg" class="card-img-top" alt="Produk 1">
                    <div class="card-body">
                        <h5 class="card-title">AOC 24B3HM 24"</h5>
                    </div>
                    <ul class="list-group list-group-flush">
                        <li class="list-group-item">Layar (1920 x 1080) 24"</li>
                        <li class="list-group-item">Kecepatan Refresh 75Hz</li>
                        <li class="list-group-item">Respon time 4ms</li>
                        <li class="list-group-item">Rp 1.329.900</li>
                    </ul>
                    <div class="card-body d-flex justify-content-center">
                        <button type="button" class="btn btn-primary">Tambah Ke Keranjang</button>
                    </div>
            ...
            <div class="col">
                <div class="card" style="width: 18rem;">
                    <img src="../img/standart/Acer K243YE.jpg" class="card-img-top" alt="Produk 1">
                    <div class="card-body">
                        <h5 class="card-title">Acer K243YE 24"</h5>
                    </div>
                    <ul class="list-group list-group-flush">
                        <li class="list-group-item">Layar (1920 x 1080) 24"</li>
                        <li class="list-group-item">Kecepatan Refresh 75Hz</li>
                        <li class="list-group-item">Respon time 1ms</li>
                        <li class="list-group-item">Rp 1.559.900</li>
                    </ul>
                    <div class="card-body d-flex justify-content-center">
                        <button type="button" class="btn btn-primary">Tambah Ke Keranjang</button>
                    </div>
