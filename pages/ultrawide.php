...
<body>
    ...
    <div class="container text-center" id="produk">
        <h2>Monitor UltraWide</h2>
        <div class="row align-items-center">
            <div class="col">
                <div class="card" style="width: 18rem;">
                    <img src="../img/ultrawide/LG 26WQ500-B.jpg" class="card-img-top" alt="Produk 1">
                    <div class="card-body">
                        <h5 class="card-title">LG 26WQ500-B 26"</h5>
                    </div>
                    <ul class="list-group list-group-flush">
                        <li class="list-group-item">Layar Full HD (2560 x 1080) 25.7"</li>
                        <li class="list-group-item">Kecepatan Refresh 75Hz</li>
                        <li class="list-group-item">Respon time 5ms</li>
                        <li class="list-group-item">Rp 2.185.000</li>
                    </ul>
            ...
            <div class="col">
                <div class="card" style="width: 18rem;">
                    <img src="../img/ultrawide/Samsung ViewFinity S5.jpg" class="card-img-top" alt="Produk 1">
                    <div class="card-body">
                        <h5 class="card-title">Samsung ViewFinity S5 34"</h5>
                    </div>
                    <ul class="list-group list-group-flush">
                        <li class="list-group-item">Layar (3440 x 1440) 34"</li>
                        <li class="list-group-item">Kecepatan Refresh 100Hz</li>
                        <li class="list-group-item">Respon time 5ms</li>
                        <li class="list-group-item">Rp 4.989.000</li>
                    </ul>
                    <div class="card-body d-flex justify-content-center">
                        <button type="button" class="btn btn-primary">Tambah Ke Keranjang</button>
                    </div>
            ...
            <div class="col">
                <div class="card" style="width: 18rem;">
                    <img src="../img/ultrawide/Samsung Odyssey G5.jpg" class="card-img-top" alt="Produk 1">
                    <div class="card-body">
                        <h5 class="card-title">Samsung Odyssey G5 34"</h5>
                    </div>
                    <ul class="list-group list-group-flush">
                        <li class="list-group-item">Layar (3440 x 1440) 34"</li>
                        <li class="list-group-item">Kecepatan Refresh 165Hz</li>
                        <li class="list-group-item">Respon time 1ms</li>
                        <li class="list-group-item">Rp 5.999.000</li>
                    </ul>
                    <div class="card-body d-flex justify-content-center">
                        <button type="button" class="btn btn-primary">Tambah Ke Keranjang</button>
                    </div>
            ...
            <div class="col">
                <div class="card" style="width: 18rem;">
                    <img src="../img/ultrawide/Lenovo L29W-30.jpg" class="card-img-top" alt="Produk 1">
                    <div class="card-body">
                        <h5 class="card-title">Lenovo L29W-30 29"</h5>
                    </div>
                    <ul class="list-group list-group-flush">
                        <li class="list-group-item">Layar (2560 x 1080) 29"</li>
                        <li class="list-group-item">Kecepatan Refresh 165Hz</li>
                        <li class="list-group-item">Respon Time 4ms</li>
                        <li class="list-group-item">Rp 3.087.900</li>
                    </ul>
                    <div class="card-body d-flex justify-content-center">
                        <button type="button" class="btn btn-primary">Tambah Ke Keranjang</button>
                    </div>
            ...
            <div class="col">
                <div class="card" style="width: 18rem;">
                    <img src="../img/ultrawide/Dell P3421W.jpg" class="card-img-top" alt="Produk 1">
                    <div class="card-body">
                        <h5 class="card-title">Dell P3421W Curved 34"</h5>
                    </div>
                    <ul class="list-group list-group-flush">
                        <li class="list-group-item">Layar (3440 x 1440) 34"</li>
                        <li class="list-group-item">Kecepatan Refresh 60Hz</li>
                        <li class="list-group-item">Respon time 5ms</li>
                        <li class="list-group-item">Rp 9.834.900</li>
                    </ul>
                    <div class="card-body d-flex justify-content-center">
                        <button type="button" class="btn btn-primary">Tambah Ke Keranjang</button>
                    </div>
            ...
            <div class="col">
                <div class="card" style="width: 18rem;">
                    <img src="../img/ultrawide/AOC Gaming CU34G3S.jpg" class="card-img-top" alt="Produk 1">
                    <div class="card-body">
                        <h5 class="card-title">AOC CU34G3S Curved 34"</h5>
                    </div>
                    <ul class="list-group list-group-flush">
                        <li class="list-group-item">Layar (3440 x 1440) 34"</li>
                        <li class="list-group-item">Kecepatan Refresh 165Hz</li>
                        <li class="list-group-item">Respon time 1ms</li>
                        <li class="list-group-item">Rp 7.099.000</li>
                    </ul>
                    <div class="card-body d-flex justify-content-center">
                        <button type="button" class="btn btn-primary">Tambah Ke Keranjang</button>
                    </div>
            ...
            <div class="col">
                <div class="card" style="width: 18rem;">
                    <img src="../img/ultrawide/ASUS VG30VQL1A.jpg" class="card-img-top" alt="Produk 1">
                    <div class="card-body">
                        <h5 class="card-title">ASUS VG30VQL1A 30" Curved</h5>
                    </div>
                    <ul class="list-group list-group-flush">
                        <li class="list-group-item">Layar (2560 x 1080) 30"</li>
                        <li class="list-group-item">Kecepatan Refresh 200Hz</li>
                        <li class="list-group-item">Respon time 1ms</li>
                        <li class="list-group-item">Rp 4.099.900</li>
                    </ul>
                    <div class="card-body d-flex justify-content-center">
                        <button type="button" class="btn btn-primary">Tambah Ke Keranjang</button>
                    </div>
            ...
            <div class="col">
                <div class="card" style="width: 18rem;">
                    <img src="../img/ultrawide/AOC Gaming CU34G3S.jpg" class="card-img-top" alt="Produk 1">
                    <div class="card-body">
                        <h5 class="card-title">Cooler Master GM34CW 34"</h5>
                    </div>
                    <ul class="list-group list-group-flush">
                        <li class="list-group-item">Layar (3440 x 1440) 34"</li>
                        <li class="list-group-item">Kecepatan Refresh 144 (165Hz oc)</li>
                        <li class="list-group-item">Respon time 1ms</li>
                        <li class="list-group-item">Rp 5.889.900</li>
                    </ul>
                    <div class="card-body d-flex justify-content-center">
                        <button type="button" class="btn btn-primary">Tambah Ke Keranjang</button>
                    </div>
